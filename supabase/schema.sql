...
CREATE INDEX idx_hardware_inventory_counts_hardware_id ON hardware_inventory_counts(hardware_id);
CREATE INDEX idx_hardware_inventory_counts_counted_at ON hardware_inventory_counts(counted_at DESC);
ALTER TABLE hardware_inventory_counts ENABLE ROW LEVEL SECURITY;
CREATE POLICY "Allow all" ON hardware_inventory_counts FOR ALL USING (true) WITH CHECK (true);
...
CREATE INDEX idx_thread_inventory_counts_thread_id ON thread_inventory_counts(thread_id);
CREATE INDEX idx_thread_inventory_counts_counted_at ON thread_inventory_counts(counted_at DESC);
ALTER TABLE thread_inventory_counts ENABLE ROW LEVEL SECURITY;
CREATE POLICY "Allow all" ON thread_inventory_counts FOR ALL USING (true) WITH CHECK (true);
